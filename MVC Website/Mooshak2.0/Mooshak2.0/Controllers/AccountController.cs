...
namespace Mooshak2._0.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            ApplicationUser User = Ident.GetUser(model.Email);
            Ident.ChangePassword(User.Id, NewPassword);
            ...
            string Informations = "Username: " + model.Email + "\n" + " Password: " + NewPassword;
            message.Body = string.Format(body, Email, model.Email, Informations);
